Shader "Custom/Terrain World Space Shader" {
	...
	Properties{
		...
		_Height2("Max Height for Texture 2", float) = 6.0
		_Texture2("Texture 2 (RGB)", 2D) = "surface" {}
		_Height3("Max Height for Texture 3", float) = 8.0
		_Texture3("Texture 3 (RGB)", 2D) = "surface" {}
		_Height4("Max Height for Texture 4", float) = 10.0
		_Texture4("Texture 4 (RGB)", 2D) = "surface" {}
		_Height5("Max Height for Texture 5", float) = 12.0
		_Texture5("Texture 5 (RGB)", 2D) = "surface" {}
		_Height6("Max Height for Texture 6", float) = 14.0
		_Texture6("Texture 6 (RGB)", 2D) = "surface" {}
		_Height7("Max Height for Texture 7", float) = 16.0
		_Texture7("Texture 7 (RGB)", 2D) = "surface" {}
		_Height8("Max Height for Texture 8", float) = 18.0
		_Texture8("Texture 8 (RGB)", 2D) = "surface" {}
		_Height9("Max Height for Texture 9", float) = 20.0
		_Texture9("Texture 9 (RGB)", 2D) = "surface" {}
		_Height10("Max Height for Texture 10", float) = 22.0
		_Texture10("Texture 10 (RGB)", 2D) = "surface" {}
		_Height11("Max Height for Texture 11", float) = 24.0
		_Texture11("Texture 11 (RGB)", 2D) = "surface" {}
		_Height12("Max Height for Texture 12", float) = 26.0
